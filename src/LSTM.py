...
if __name__ == "__main__":
    ...
    model, checkpointer = second_version.get_model_to_train(True)
    ...
    model.fit(X_train, y_train, epochs=60, batch_size=32, validation_data=(X_test, y_test), callbacks=[checkpointer])
